...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'vacancies_vacancy', 'description', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Vacancy.description'
        db.alter_column(u'vacancies_vacancy', 'description', self.gf('django.db.models.fields.TextField')(null=True))
